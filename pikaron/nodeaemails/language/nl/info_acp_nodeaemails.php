...
$lang = array_merge($lang, array(
		...
		'LOG_FORCE_CHG_EMAIL'				=> '<strong>Geen DEA E-mails</strong><br>» %s',
		'LOG_FORCE_USERS_CHG_EMAIL'			=> '<strong>Gemarkeerde gebruikers VERPLICHTEN hun om e-mail te VERANDEREN</strong>',
		'LOG_FORCE_USERS_NO_CHG_EMAIL'		=> '<strong>ONGEMARKEERDE gebruikers VERPLICHTEN om hun e-mail te VERANDEREN</strong>',
		'LOG_FORCE_USER_CHG_EMAIL'			=> 'Gebruiker gemarkeerd om hun e-mail te VERANDEREN',
		'L_NO_DEA_EMAILS_DELAY'				=> 'Interval voor uitvoering van de CRON',
		'L_NO_DEA_EMAILS_DELAY_EXPLAIN'		=> '(Minimum: 15 seconden, Maximum: 86400 seconden = 1 dag)',
		...
		'L_NO_DEA_EMAILS_DOM_SAVE'			=> 'Het DEA Email Domein is correct opgeslagen: <strong>((%s))</strong>',
		...
		'L_NO_DEA_EMAILS_FORCE_CHG_EMAIL'	=> 'Wijziging van “e-mail” forceren',
		'L_NO_DEA_EMAILS_N_FORCE_CHG_EMAIL' => 'Forceer de wijziging van “e-mail” NIET',
		...
		'L_NO_DEA_EMAILS_PERCENTAGE'		=> '<i>(%s &#37; van totaal geregistreerde gebruikers)</i>',
));
